...
public final class CameraManager {
    ...
    public void closeLight(ImageView imageView, Handler handler) {
        ...
        if (camera != null) {
            ...
            imageView.setImageResource(R.drawable.qr_light);
            camera.autoFocus(autoFocusCallback);
        }
    }

    public void openLight(ImageView imageView, Handler handler) {
    ...
    public synchronized void setTorch(boolean newSetting, Handler handler) {
