...
public class AlbumGridViewAdapter extends BaseAdapter {
    ...
    private ArrayList<com.wei.image.select_pic.ImageItem> dataList;
    ...
    BitmapCache.ImageCallback callback = new com.wei.image.select_pic.BitmapCache.ImageCallback() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (path.contains("camera_default")) {
            ...
            final com.wei.image.select_pic.ImageItem item = dataList.get(position);
