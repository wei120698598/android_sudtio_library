...
public class AlbumGridViewAdapter extends BaseAdapter {
    ...
    private ArrayList<com.wei.image.imageChoose.ImageItem> dataList;
    ...
    BitmapCache.ImageCallback callback = new com.wei.image.imageChoose.BitmapCache.ImageCallback() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (path.contains("camera_default")) {
            ...
            final com.wei.image.imageChoose.ImageItem item = dataList.get(position);
