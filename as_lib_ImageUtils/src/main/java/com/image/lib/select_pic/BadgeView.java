...
public class BadgeView extends TextView {
    ...
    public static final int POSITION_LEFT_CENTER = 8;
    ...
    private Drawable getDefaultBackground() {
        if (noText)
            return getResources().getDrawable(R.drawable.voice_unread);
        else
            return getResources().getDrawable(R.drawable.unread_dot);
    }
