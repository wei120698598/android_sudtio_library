...
public class AlbumGridViewAdapter extends BaseAdapter {
	...
	com.image.lib.select_pic.BitmapCache cache;

	public AlbumGridViewAdapter(Context c, ArrayList<com.image.lib.select_pic.ImageItem> dataList, ArrayList<com.image.lib.select_pic.ImageItem> selectedDataList) {
		context = c;
		cache = new com.image.lib.select_pic.BitmapCache();
	...
	com.image.lib.select_pic.BitmapCache.ImageCallback callback = new com.image.lib.select_pic.BitmapCache.ImageCallback() {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_plugin_camera_select_imageview, parent, false);
