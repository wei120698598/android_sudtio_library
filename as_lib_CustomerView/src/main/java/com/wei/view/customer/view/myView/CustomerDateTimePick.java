...
public class CustomerDateTimePick extends AlertDialog implements OnDateChangedListener {
	...
	public CustomerDateTimePick(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
		this(context, 0, callBack, year, monthOfYear, dayOfMonth);
	}

	public CustomerDateTimePick(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
		super(context, theme);
