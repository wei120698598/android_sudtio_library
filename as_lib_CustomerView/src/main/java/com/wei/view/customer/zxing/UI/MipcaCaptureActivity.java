package com.wei.view.customer.zxing.ui;
...
import com.wei.view.customer.zxing.decoding.RGBLuminanceSource;
import com.wei.view.customer.zxing.camera.CameraManager;
import com.wei.view.customer.zxing.decoding.CaptureActivityHandler;
import com.wei.view.customer.zxing.decoding.DecodeFormatManager;
import com.wei.view.customer.zxing.decoding.InactivityTimer;
import com.wei.view.customer.zxing.view.ViewfinderView;
...
public class MipcaCaptureActivity extends Activity implements Callback {
	...
	public static int REQUEST_CODE_LOCAL = 99;
	...
	public void handleDecode(String resultString, Bitmap barcode) {// 返回扫描的数据
		...
		if (resultString.equals("")) {
			...
			resultIntent.putExtra("result", recode(resultString));
