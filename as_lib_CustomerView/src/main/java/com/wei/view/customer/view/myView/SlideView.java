...
public class SlideView extends LinearLayout {
	...
	public SlideView(Context context, int type, int width) {
		super(context);
		initView(type, width);
	}

	public SlideView(Context context, AttributeSet attrs, int type, int width) {
		super(context, attrs);
		initView(type, width);
	}

	private void initView(int type, int width) {
		context = getContext();
		mScroller = new Scroller(context);

		setOrientation(LinearLayout.HORIZONTAL);
		View view = View.inflate(context, type, this);
