...
public class LazyViewPager extends ViewGroup {
	...
	// 屏蔽预加载功能
	private static final int DEFAULT_OFFSCREEN_PAGES = 2;// 默认viewpager当前变量的值1
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight() - getPaddingTop() - getPaddingBottom(),
				MeasureSpec.EXACTLY);
